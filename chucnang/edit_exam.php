            ...
            <form method="POST" action="update_exam.php">
                ...
                <div class="form-group">
                    ...
                    <select name="difficulty" id="difficulty" required>
                        <option value="Dễ" <?php if($exam['difficulty']=="Dễ") echo "selected"; ?>>Dễ</option>
                        <option value="Trung bình" <?php if($exam['difficulty']=="Trung bình") echo "selected"; ?>>Trung bình</option>
                        <option value="Khó" <?php if($exam['difficulty']=="Khó") echo "selected"; ?>>Khó</option>
                    </select>
                </div>
