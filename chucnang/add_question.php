...
$title = $exam['title'] ?? 'Không xác định';
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<main>
    <h2>Thêm câu hỏi cho đề thi <?php echo htmlspecialchars($title); ?></h2>
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    essayFields.style.display = qType === 'essay' ? 'block' : 'none';
});
</script>
</body>
</html>
