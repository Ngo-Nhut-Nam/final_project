        ...
        <section id="profile" class="page active">
            <div class="profile-container">
                ...
                <form id="profile-form" method="post" action="update_profile.php">
                    ...
                    <div class="form-group">
                        <label for="profile-password">Mật khẩu</label>
                        <input type="password" id="profile-password" name="password" 
                               value="<?php echo htmlspecialchars($user['password']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="profile-exams">Danh sách bài thi</label>
                        <input type="text" id="profile-exams" 
                               value="Toán học, Vật lý, Hóa Học" disabled>
                    </div>
